...
| 部件 | 文件名 | 许可证 |
|------|--------|--------|
| 头部 | OttoDIY+_head_V9.stl | CERN OHL v2.0 |
| 身体 | OttoDIY+_body_V9.stl | CERN OHL v2.0 |
| 腿部 | OttoDIY+_Leg_V9.stl | CERN OHL v2.0 |
| 脚部 | OttoDIY+_foot_V9.stl | CERN OHL v2.0 |
...
- OTTO 库 (4舵机布局): https://github.com/OttoDIY/OttoDIYLib
...
|------|--------|------|----------|--------|
| **0.96" OLED (SSD1306)** | 128x64 | I2C | 0x3C | U8g2 / Adafruit_SSD1306 |
| **1.3" OLED (SH1106)** | 128x64 | I2C | 0x3C | U8g2 / Adafruit_SH1106 |
| **1.44" TFT** | 128x128 | SPI | - | TFT_eSPI |
...
| **Adafruit_SSD1306** | SSD1306 I2C 专用 |
| **TFT_eSPI** | TFT 彩色屏幕 |
...
|------|--------|--------|------|------|--------|
| **ESP32-CAM (AI-Thinker)** | OV2640 | 2MP | ESP32内置 | 160-310mA | ¥25-40 |
...
| OTTO 3D 打印件 | 1套 | 自打印或采购 | GitHub STL |
