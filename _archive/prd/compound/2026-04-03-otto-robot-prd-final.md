...
| v3.1 | 2026-04-06 | 一致性修复：增加班级规模基准（30人/班）；编程工具选型确定为 Otto Blockly；R5 离线模式改为 LED+语音提示并明确离线指令列表；R12 硬件规格增加 Flash 存储和 LED 指示灯；R19 音乐存储明确为内置 Flash；删除未使用的 MCP 术语；AI 数据集标注责任方和 MVP 降级方案 |
